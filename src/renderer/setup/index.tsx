...
import './style.css';
import '../updates.css';
import { UpdateCenter } from '../updates.tsx';
...
function App() {
  ...
  return <><div className="setup-titlebar">DSH Desktop</div><main>
    ...
    <footer><span>DSH Desktop {info?.version ?? ''}</span><UpdateCenter always /><button onClick={() => { void window.dshDesktop?.openExternal('https://github.com/deepseek-ai/deepseek-harness'); }}>项目文档 ↗</button></footer>
  </main></>;
}
