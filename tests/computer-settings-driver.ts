...
export const fixture = {
  ...
  prompts: 0, starts: 0, stops: 0, resets: 0, fail: false,
  start: undefined as undefined | (() => Promise<void>),
};
export async function resetDshComputerPermissions() { fixture.resets++; }
export class CuaComputerDriver {
  ...
  async capturePreview() { throw new Error('Settings fixture must never capture a preview'); }
