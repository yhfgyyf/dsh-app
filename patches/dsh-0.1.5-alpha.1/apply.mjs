...
const backup=join(process.env.DSH_HOME??join(homedir(),'.dsh'),'backups','local-fixes-0.1.5-alpha.1-'+new Date().toISOString().replace(/[:.]/g,'-'));await mkdir(backup,{recursive:true,mode:0o700});
